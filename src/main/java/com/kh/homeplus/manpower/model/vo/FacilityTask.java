...
public class FacilityTask {
	...
	public FacilityTask(String ft_code, String comName, String ft_cate, String ft_detail, String ft_need,
			char ft_status) {
		super();
	...
	public String toString() {
		return "FacilityTask [ft_code=" + ft_code + ", comName=" + comName + ", ft_cate=" + ft_cate + ", ft_detail="
				+ ft_detail + ", ft_need=" + ft_need + ", ft_status=" + ft_status + "]";
	}
