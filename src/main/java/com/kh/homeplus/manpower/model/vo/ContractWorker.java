...
public class ContractWorker {
	...
	public ContractWorker(int contracta, int contractb, int contractc, int contractd, int contracte) {
		super();
	...
	public String toString() {
		return "ContractWorker [contracta=" + contracta + ", contractb=" + contractb + ", contractc=" + contractc
