...
public class Board {
	...
	private String b_status; // 게시글 삭제 여부 
	...
	private String b_category; // 게시판 말머리(잡담,질문 등)
	
	public Board() {}

	public Board(String b_code, String m_id, String b_title, String b_content, int b_count, String b_status,
			String b_name, Date b_create_date, Date b_mdify_date, String orignal_filename, String rename_filename,
			String b_category) {
		super();
		this.b_code = b_code;
		this.m_id = m_id;
	...
	public String toString() {
		return "Board [b_code=" + b_code + ", m_id=" + m_id + ", b_title=" + b_title + ", b_content=" + b_content
