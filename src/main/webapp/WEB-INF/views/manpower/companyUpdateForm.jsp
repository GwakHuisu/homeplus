				...
				<div class="card-box">
					...
					<div class="table-responsive">
						<table class="table table-hover mails m-0 table table-actions-bar">
							...
							<tbody>
								<div class="m-b-20">
									<form action="cupdate.do" class="form-validation" method="POST" enctype="multipart/form-data">
										<input type="hidden" value="${ company.comCode }" name="comCode">
										<div class="form-group">
											<label for="a">업체 구분<span class="text-danger">*</span></label>
											<input type="text" name="comDivision" parsley-trigger="change" required
												class="form-control" id="userName" style="width: 60%;" value="${company.comDivision}">
										</div>
										<div class="form-group">
											<label for="b">업체 이름<span class="text-danger">*</span></label>
											<input type="text" name="comName" parsley-trigger="change" required
												class="form-control" id="comName" style="width: 60%;" value="${company.comName}">
										</div>
										<div class="form-group">
											<label for="c">대표<span class="text-danger">*</span></label> <input
												type="text" name="comCeo" parsley-trigger="change" required
												class="form-control" id="comCeo" style="width: 60%;" value="${company.comCeo}">
										</div>
										<div class="form-group">
											<label for="d">계약 시작일<span class="text-danger">*</span></label>
											<input type="date" name="comStartDate" parsley-trigger="change" required
												class="form-control" id="comStartDate" style="width: 60%;" value="${company.comStartDate}">
										</div>
										<div class="form-group">
											<label for="e">계약 만료일<span class="text-danger">*</span></label>
											<input type="date" name="comEndDate" parsley-trigger="change"
												required class="form-control" id="comEndDate"
												style="width: 60%;" value="${company.comEndDate}">
										</div>
										<div class="form-group">
											<label for="f">설립일<span class="text-danger">*</span></label>
											<input type="date" name="comEsDate" parsley-trigger="change" required
												class="form-control" id="comEsDate" style="width: 60%;" value="${company.comEsDate}">
										</div>
										<div class="form-group">
											...
											<input type="text" name="comScale" parsley-trigger="change"
												...
												style="width: 60%;" value="${company.comScale}">
										</div>
										<div class="form-group">
											...
											<input type="number" name="comNw" parsley-trigger="change"
												...
												style="width: 60%;" value="${company.comNw}">
										</div>
										<div class="form-group">
											...
											<input type="text" name="comCapital" parsley-trigger="change"
												...
												style="width: 60%;" value="${company.comCapital}">
										</div>
										<div class="form-group">
											...
											<input type="text" name="comMajor" parsley-trigger="change"
												...
												style="width: 60%;" value="${company.comMajor}">
										</div>
										<div class="form-group">
											...
											<input type="text" name="comTel" parsley-trigger="change"
												...
												style="width: 60%;" value="${company.comTel}">
										</div>
										<div class="form-group">
											...
											<input type="number" name="comPay" parsley-trigger="change"
												...
												style="width: 60%;" value="${company.comPay}">
										</div>
										...
										<div class="form-group text-right m-b-0">
											...
											<input type="reset"
												class="btn btn-default waves-effect m-l-5" value="되돌리기">
											<button type="reset"
