				...
				<div style="margin-bottom:5%;">
					...
					<div class="ttable">					    
					    <table class="table">
					    	...
					    	<tr><td>근무 장소</td><td><input type="text" size="20"></td><td>소속 업체</td><td><input type="text" size="20"></td></tr>
					    	<tr><td>연락처</td><td><input type="text" size="20"></td><td>계약기간</td><td><input type="text" size="20"></td></tr>
					    	<tr><td>주소</td><td><input type="text" size="20"></td><td>/</td><td><input type="text" size="20"></td></tr>
					    </table>   
					</div>
					<button onclick="location.href='wupdate.do'">등록하기</button>&nbsp;&nbsp;
