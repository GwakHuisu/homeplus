						...
						<div class="col-md-12">
							<form id="updateMeberForm" method="POST"
								...
								<div>
									...
									&nbsp;&nbsp; <input name="aId" style="margin-bottom: 16px;"
										value="${loginUser.aId}">
								</div>
								<div>
									<h5 class="fontWeight-600 display-inlnine-block">주소 :</h5>
									&nbsp;&nbsp; <input name="aAddress"
										style="margin-bottom: 16px;" value="${loginUser.aAddress}">
								</div>
								<div>
									<h5 class="fontWeight-600 display-inlnine-block">전화번호 :</h5>
									&nbsp;&nbsp;
									<c:if test="${empty loginUser.aPhone }">
										<input name="aPhone" style="margin-bottom: 16px;"
											placeholder="-없이 입력" value="">
									</c:if>
									<c:if test="${!empty loginUser.aPhone }">
										<input name="aPhone" style="margin-bottom: 16px;"
											placeholder="-없이 입력" value="${loginUser.aPhone }">
									</c:if>
								</div>
								<div>
									...
									<c:if test="${empty loginUser.aEmail }">
										<input name="aEmail" style="margin-bottom: 16px;"
											placeholder="이메일을 입력하세요" value="">
									</c:if>
									<c:if test="${!empty loginUser.aEmail }">
										<input name="aEmail" style="margin-bottom: 16px;"
											placeholder="이메일을 입력하세요" value="${loginUser.aEmail }">
									</c:if>
								</div>
