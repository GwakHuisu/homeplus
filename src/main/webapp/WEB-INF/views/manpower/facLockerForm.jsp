							...
							<div class="col-sm-12">
								...
								<div class="col-lg-3 col-sm-6">
									<div class="widget-inline-box text-center b-0" id="writeMsg">
										<a href="mpMsgSendForm.do" id="msgMenu"><i
                                        ...
                                        <table class="table table-hover mails m-0 table table-actions-bar">
                                            ...
                                            <tbody>
                                               <c:forEach var="me" items="${ meList }">
												<tr>
													...
													<c:url var="meLockDetail" value="mpmeLockDetail.do">
											...
											<tr align="center" height="20" id="pageTable">
												<td colspan="6">
													...
													<c:if test="${ pi.currentPage > 1 }">
														<c:url var="before" value="mpLockerForm.do">
													...
													<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
														...
														<c:if test="${ p ne pi.currentPage }">
															<c:url var="pagination" value="mpLockerForm.do">
													...
													<c:if test="${ pi.currentPage < pi.maxPage }">
														<c:url var="after" value="mpLockerForm.do">
															<c:param name="page" value="${ pi.currentPage + 1 }"/>
															<c:param name="aName" value="${ loginUser.aName }"/> 
														</c:url>
