									...
									<div class="row" height="80px">
										<div class="col-lg-3 col-sm-6">
											<div class="widget-inline-box text-center" id="receivedMsg">
												...
												<c:url var="goSended" value="mpSendedForm.do">
													<c:param name="aName" value="${ loginUser.aName }"/>
												</c:url>
												<c:url var="goLocker" value="mpLockerForm.do">
													<c:param name="aName" value="${ loginUser.aName }"/>
												</c:url>
										...
										<div class="col-lg-3 col-sm-6">
											<div class="widget-inline-box text-center" id="sendedMsg">
												<a href="${ goSended }" id="msgMenuSelected"><i class="mdi mdi-package-up"></i> 보낸 메세지</a>
											</div>
										</div>
										...
										<div class="col-lg-3 col-sm-6">
											<div class="widget-inline-box text-center b-0" id="writeMsg">
												<a href="mpMsgSendForm.do" id="msgMenu"><i class="mdi mdi-pencil-box"></i> 메세지 작성</a>
											</div>
										</div>
                                ...
                                <!-- <form method="post" name="form"> -->
                                    ...
                                    <div class="etcBtn">
	                                     <div class="form-group">
                                                <label class="col-md-2 control-label">보낸 메시지함</label>
                                                <br><br>
                                                <div class="col-md-13">
                                                	<input type="hidden" value="${ message.meWriter }" name="forWho">
                                                    <input type="text" class="form-control" value="받는사람 : ${ message.meReceiver }" readonly>
                                                    <br>
                                    ...
                                    <br>
                                        ...
                                        <br>
                                         ...
                                         <input type="submit" value="보관하기" onclick="javascript: form.action='mpmessageLock.do';" class="btn btn-default waves-effect m-l-5"/>
                                         <input type="submit" value="삭제하기" onclick="javascript: form.action='mpmessageDelete.do';" class="btn btn-default waves-effect m-l-5"/>
                                         </div>
                                         <br><br>
                                         </form>
                                    </div>
