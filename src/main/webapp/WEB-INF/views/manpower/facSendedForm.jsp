							...
							<div class="row" height="80px">
								...
								<div class="col-lg-3 col-sm-6">
									<div class="widget-inline-box text-center b-0" id="writeMsg">
										<a href="mpsMsgSendForm.do" id="msgMenu"><i
										...
										<tbody>
											<c:forEach var="me" items="${ meList }">
												<tr>
													...
													<c:url var="meSendedDetail" value="mpSendedDetail.do">
												...
												<tr align="center" height="20" id="pageTable">
													<td colspan="6">
														...
														[이전] &nbsp;
															...
															<c:url var="before" value="mpSendedForm.do">
															...
															<c:if test="${ p ne pi.currentPage }">
																<c:choose>
																	...
																	<c:otherwise>
																		<c:url var="pagination" value="mpSendedForm.do">
														...
														[다음]
															...
															<c:url var="after" value="mpSendedForm.do">
																<c:param name="page" value="${ pi.currentPage + 1 }" />
																<c:param name="maName" value="${ loginUser.aName }" />
															</c:url>
