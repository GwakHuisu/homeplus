										...
										<tbody>
											<c:forEach var="me" items="${ meList }">
												<tr>
													...
													<c:url var="meReceiveDetail" value="mpReceiveDetail.do">
												...
												<tr align="center" height="20" id="pageTable">
													<td colspan="6">
														...
														[이전] &nbsp;
															...
															<c:url var="before" value="mpMessageForm.do">
															...
															<c:if test="${ p ne pi.currentPage }">
																<c:choose>
																	...
																	<c:otherwise>
																		<c:url var="pagination" value="mpMessageForm.do">
														...
														[다음]
															...
															<c:url var="after" value="mpMessageForm.do">
																<c:param name="page" value="${ pi.currentPage + 1 }" />
																<c:param name="maName" value="${ loginUser.aName }" />
															</c:url>
