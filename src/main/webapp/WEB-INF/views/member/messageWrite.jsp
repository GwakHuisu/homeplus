	...
	<div id="total">
		...
		<div id="main">
			<div class="ingu">
				...
				<div id="headTitle">
					<h4>
						<a href="writeMsg.do" id="title">보낸 쪽지</a>
					</h4>
				...
				<div class="boardArea">
					<table class="sub_news" border="1" align="center">
						<thead>
							<tr>
								...
								<th align="center" width="80">받는 사람</th>
						...
						<tfoot>
							<c:if test="${searchValue eq null }">
								<c:set var="loc" value="writeMsg.do" />
							</c:if>
							<c:if test="${searchValue ne null }">
								<c:set var="loc" value="searchWriteMsg.do" />
							</c:if>
					...
					<div id="searchArea" align="center">
						<form action="searchWriteMsg.do" name="searchForm" method="post">							
