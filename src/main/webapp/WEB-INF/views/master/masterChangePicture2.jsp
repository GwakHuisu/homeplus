...
<body>
	...
	<br>
		 <div class="col-lg-6">
		 <div class="card-box">
	        	<label class="control-label">기존 둘러보기 페이지 두번째 이미지</label>
	             <input type="text" readonly="readonly" value="${ la.laPicture2 }" class="form-control">
	             <br>
	             <img src="${ contextPath }/resources/maUploadFiles/${ la.laPicture2 }" width="100%">    
	     </div>
	     </div>
	     <form action="masterUpdateLaPicture2.do" method="POST" enctype="multipart/form-data">
	       <div class="col-lg-6">
	       <div class="card-box">    
	             <label class="control-label">변경할 둘러보기 페이지 두번째 이미지</label>
