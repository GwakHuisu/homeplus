									...
									<div class="row" height="80px">
										...
										<div class="col-lg-3 col-sm-6">
											<div class="widget-inline-box text-center b-0" id="writeMsg">
												<a href="masterMsgSendForm.do" id="msgMenuSelected"><i class="mdi mdi-pencil-box"></i> 메세지 작성</a>
											</div>
										</div>
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="etcBtn">
	                                     <div class="form-group">
                                                ...
                                                <br><br>
                                                <div class="col-md-13">
                                                    <input type="text" class="form-control" value="${ forWho }" placeholder="받는사람" name="meReceiver" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-13">
