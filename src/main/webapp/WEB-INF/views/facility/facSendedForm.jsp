							...
							<div class="row" height="80px">
								...
								<div class="col-lg-3 col-sm-6">
									<div class="widget-inline-box text-center" id="sendedMsg">
										<a href="${ goSended }" id="msgMenuSelected"><i
								...
								<div class="col-lg-3 col-sm-6">
									<div class="widget-inline-box text-center b-0" id="writeMsg">
										<a href="facMsgSendForm.do" id="msgMenu"><i
							...
							<div class="card-box">
								...
								<div class="table-responsive">
									<table
										...
										<thead>
											<tr>
												<th style="min-width: 95px;">받는사람</th>
												<th>내용</th>
												<th>날짜</th>
												<th>확인</th>
											</tr>
										...
										<tbody>
											<c:forEach var="me" items="${ meList }">
												<tr>
													<td id="msgWriter">${ me.meReceiver }</td>
													<c:url var="meSendedDetail" value="facSendedDetail.do">
														<c:param name="meCode" value="${ me.meCode }" />
													</c:url>

													<td id="msgContent"><a href="${ meSendedDetail }"
												...
												<tr align="center" height="20" id="pageTable">
													<td colspan="6">
														...
														[이전] &nbsp;
															...
															<c:url var="before" value="facSendedForm.do">
															...
															<c:if test="${ p ne pi.currentPage }">
																<c:choose>
																	...
																	<c:otherwise>
																		<c:url var="pagination" value="facSendedForm.do">
														...
														[다음]
															...
															<c:url var="after" value="facSendedForm.do">
																<c:param name="page" value="${ pi.currentPage + 1 }" />
																<c:param name="maName" value="${ loginUser.aName }" />
															</c:url>
