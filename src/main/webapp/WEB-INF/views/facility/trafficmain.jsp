						...
						<div class="row">
							...
							<div class="col-lg-3 col-sm-6">
								<div class="widget-inline-box text-center">
									...
									<p class="text-muted"><a href="parking.do">주차장</a></p>
								</div>
							</div>
							<div class="col-lg-3 col-sm-6">
								<div class="widget-inline-box text-center">
									...
									<p class="text-muted"><a href="roadman.do">도로</a></p>
								</div>
							</div>
							<div class="col-lg-3 col-sm-6">
								<div class="widget-inline-box text-center b-0">
									...
									<p class="text-muted"><a href="trafficenter.do">교통시설</a></p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card-box">
						...
						<div id="pagenation">
							<ul class="pagination pagination-split">
								...
								<c:if test="${pi.currentPage > 1 }">
									<li class="page-item">
										<c:url var="before" value="trafreport.do">
								...
								<c:forEach var="p" begin="${pi.startPage }" end="${pi.endPage }">
									...
									<c:if test="${p ne pi.currentPage }">
										<c:url var="pagination" value="trafreport.do">
								...
								<c:if test="${pi.currentPage < pi.maxPage }">
									<c:url var="after" value="trafreport.do">
										<c:param name="page" value="${pi.currentPage + 1}"/>
									</c:url>
