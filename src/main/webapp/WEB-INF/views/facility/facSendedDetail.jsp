									...
									<div class="row" height="80px">
										<div class="col-lg-3 col-sm-6">
											<div class="widget-inline-box text-center" id="receivedMsg">
												...
												<c:url var="goSended" value="facSendedForm.do">
													<c:param name="aName" value="${ loginUser.aName }"/>
												</c:url>
												<c:url var="goLocker" value="facLockerForm.do">
													<c:param name="aName" value="${ loginUser.aName }"/>
												</c:url>
                                ...
                                <!-- <form method="post" name="form"> -->
                                    ...
                                    <br>
                                        ...
                                        <br>
                                         ...
                                         <input type="submit" value="보관하기" onclick="javascript: form.action='facmessageLock.do';" class="btn btn-default waves-effect m-l-5"/>
                                         <input type="submit" value="삭제하기" onclick="javascript: form.action='facmessageDelete.do';" class="btn btn-default waves-effect m-l-5"/>
                                         </div>
                                         <br><br>
                                         </form>
                                    </div>
